...
class ldap {
    ...
    private $ldapServer  = 'elke.dnna.gr';
    private $ldapPort = '389';
    public $suffix = '@teiath.gr';
    public $baseDN = 'dc=teiath, dc=gr';
    private $ldapUser = 'cn=admin,dc=teiath,dc=gr';
    private $ldapPassword = '##bp94cP58#a';

<div id='footer'>
    ...
    <div id='footer-main'>
        ...
        <?php
            ...
            echo $this->Html->image("logos/tei.png", array("alt" => "" ,"style" => "width:110px;height:100px;"));
            echo $this->Html->image("logos/epsa_logo_CMYK.png", array("alt" => "" ,"style" => "width:250px;height:100px;"));
            echo $this->Html->image("logos/eurwpaikienwsi.jpg", array("alt" => "" ,"style" => "width:140px;height:100px;"));
        ?>

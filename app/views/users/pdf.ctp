...
<html>
    ...
    <div class='text-area'>
        ...
        Παρακαλείσθε να ελέγξετε την ορθότητα των αναγραφόμενων στοιχείων.
        Κατόπιν, να την αποστείλετε μέσω FAX στον αριθμό
        <?php echo $authority_fax; ?> συνοδευόμενη από τα απαραίτητα αποδεικτικά
        έγγραφα.</p>
